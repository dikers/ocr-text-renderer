...
def generate_img(img_index, q=None):
    ...
    base_name = '{}{:08d}'.format(TRAIN_IMAGE_PRE, img_index)
...
def sort_labels(tmp_label_fname, label_fname):
    ...
    with open(label_fname, mode='w', encoding='utf-8') as f:
        for line in lines:
            start_index = len(TRAIN_IMAGE_PRE) + 8
            #print('{}.jpg {}'.format(line[0:start_index], line[start_index+1:]) )
            f.write('{}.jpg {}'.format(line[0:start_index], line[start_index+1:]) )
